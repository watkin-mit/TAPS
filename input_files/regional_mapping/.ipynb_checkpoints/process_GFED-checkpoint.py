...
if __name__ == '__main__':
    # the below is based on CEDS unless you write "changed"
    
    # changed
    ceds_data_dir = '/net/geoschem/data/gcgrid/data/ExtData/HEMCO/GFED4/v2015-10'
    ...
    # changed
    yr = 2014
    f_path = os.path.join(ceds_data_dir,str(yr),'GFED4_gen.025x025.201401.nc')
    ...
    ds_GPW = netCDF4.Dataset('/home/watkin/EPPA-TAPS/Python/gpw_v4_population_density_adjusted_rev11_2pt5_min.nc','r') # NOTE: changed path
    ...
    print('say hi again')
    mask_nc_path = '/home/watkin/EPPA-TAPS/aux_data2/GFED_EPPA_masks_filled.nc' # NOTE: changed path
